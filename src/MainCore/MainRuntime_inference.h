...
#ifndef H_MAINRUNTIME_INFERENCE_H__
#define H_MAINRUNTIME_INFERENCE_H__
...
/// Input buffer sizes.
#define NNABLART_MAINRUNTIME_INPUT0_SIZE (6912)
...
/// Output buffer sizes.
#define NNABLART_MAINRUNTIME_OUTPUT0_SIZE (50)
/// Pointer of allocated buffer.
float* nnablart_mainruntime_output_buffer(void* context, int index);
/// Number of parameter buffers.
#define NNABLART_MAINRUNTIME_NUM_OF_PARAM_BUFFERS (7)
/// Parameter buffer sizes.
#define NNABLART_MAINRUNTIME_PARAM0_SIZE (144)
#define NNABLART_MAINRUNTIME_PARAM1_SIZE (16)
#define NNABLART_MAINRUNTIME_PARAM2_SIZE (4096)
#define NNABLART_MAINRUNTIME_PARAM3_SIZE (16)
#define NNABLART_MAINRUNTIME_PARAM4_SIZE (800)
#define NNABLART_MAINRUNTIME_PARAM5_SIZE (2500)
#define NNABLART_MAINRUNTIME_PARAM6_SIZE (50)
/// Pointer of allocated buffer.
...
#endif //H_MAINRUNTIME_INFERENCE_H__
